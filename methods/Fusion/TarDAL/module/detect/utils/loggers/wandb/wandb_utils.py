...
class WandbLogger():
    ...
    def setup_training(self, opt):
        ...
        Setup the necessary processes for training YOLO models:
          - Attempt to download model checkpoints and dataset artifacts if opt.resume stats with WANDB_ARTIFACT_PREFIX
    ...
    def download_dataset_artifact(self, path, alias):
        """
        download the model checkpoints artifact if the path starts with WANDB_ARTIFACT_PREFIX
    ...
    def download_model_artifact(self, opt):
        """
        download the model checkpoints artifact if the resume path starts with WANDB_ARTIFACT_PREFIX
    ...
    def log_model(self, path, opt, epoch, fitness_score, best_model=False):
        """
        Log the model checkpoints as W&B artifact
        ...
        best_model (boolean) -- Boolean representing if the current checkpoints is the best yet.
        """

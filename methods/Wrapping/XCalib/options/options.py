...
from . import get_sampler_opt, get_dataset_opt, get_depth_options, get_loss_options, get_train_opt, \
    get_validation_opt


def get_options(*args, **kwargs) -> Namespace:
    with open(os.getcwd() + "/methods/Wrapping/XCalib/options/mainConf.yaml", "r") as file:

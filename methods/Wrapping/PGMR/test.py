...
import cv2
from code_pgmr.dataset import TestData
...
if __name__ == "__main__":
    ...
    for idx, [orign_warped, target, orign, image_name, disp] in tqdm(p_bar_test):
        ...
        fus_np = target_np / 2 + results_up_np / 2

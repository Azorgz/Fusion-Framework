...
from model_main.segment_loss import calculate_loss
...
parser.add_argument('--checkpoint_teacher', type=str, default='', help='location of the checkpoints')
parser.add_argument('--checkpoint_student', type=str, default='', help='location of the checkpoints')

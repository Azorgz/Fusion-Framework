...
def get_model(device, opt, **kwargs):
    config = from_dict(yaml.safe_load(Path('fusion_framework/methods/Fusion/TarDAL/config/default.yaml').open('r')))
    ...
    class Model(torch.nn.Module):
        def __init__(self):
            ...
            self.load_ckpt(torch.load(os.getcwd() + '/fusion_framework/methods/Fusion/TarDAL/checkpoints/tardal-dt.pth', map_location='cpu'))

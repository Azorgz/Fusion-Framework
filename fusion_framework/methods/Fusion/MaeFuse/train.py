...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='output_decoder_4_640/checkpoints-50.pth',
...
def train(args):
    ...
    Loss = fusion_framework.methods.Fusion.MaeFuse.util.loss.Fusionloss(1, 2).to(device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch % 5 == 0 or epoch + 1 == args.epochs):
            ...
            torch.save({'model':model.state_dict()}, args.output_dir+'/checkpoints'+str(epoch)+'.pth')

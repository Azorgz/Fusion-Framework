...
class MyOptions():
  def __init__(self):
    ...
    # training related
    self.parser.add_argument('--resume', type=str, default="methods/Wrapping/PGMR/checkpoints/regis_all.pth", help='specified the dir of saved models for resume the training')
    ...
    self.parser.add_argument('--resume_enhancer', type=str, default="methods/Wrapping/PGMR/checkpoints/enhancer.pth", help='specified the dir of saved models for resume the training')
